...
router.post("/portal/runs/cleanup", authMiddleware_1.requireAdmin, researchPortalController_1.cleanupOldRuns);
router.post("/portal/runs/cleanup-all", authMiddleware_1.requireAdmin, researchPortalController_1.cleanupAllRuns);
